 ...
 * 
 */
package science.mrcuijt.jaxws.demo3.handler;
...
//			responseElem.setPrefix("ns2");
//			responseElem.addNamespaceDeclaration("ns2", "http://WebXml.com.cn/");
			...
			responseElem.detachNode();

			responseElem = message.getSOAPBody().addChildElement("getSupportProvinceResponse", "ns2",
					"http://WebXml.com.cn/");
			element = responseElem.addChildElement("getSupportProvinceResult", "ns2");
			for (String string : result) {
				element.addChildElement("string").setTextContent(string);
			}
			
//			responseElem.appendChild(element);
