...
public class ThreadService {
	...
	static {
		...
		try {
			prop.load(Class.forName("science.mrcuijt.jaxws.client.WeatherClient").getResourceAsStream("/res.properties"));
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				SaveDataWorker2 worker = new SaveDataWorker2(socket);
